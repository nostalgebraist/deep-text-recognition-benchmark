...
def get_args(is_train=False, **kwargs):
    ...
    parser.add_argument('--workers', type=int, help='number of data loading workers. Use -1 to use all cores.', default=1)
    ...
    parser.add_argument('--FeatureExtraction', type=str, required=False, default='None',
    ...
    parser.add_argument('--Prediction', type=str, required=False, default='None', help='Prediction stage. None|CTC|Attn')
    ...
    args.num_class = len(args.character) + 2

    # others that seemed necessary (?)
    args.eval = True
